...
public class SignUp extends AppCompatActivity {
    ...
    private EditText username, password, email, no_tlpn, alamat;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        singupBtn = findViewById(R.id.btn_save2);
    ...
    public void aksiSignup() {
        ...
        String urlEndPoints = "https://ap-southeast-1.aws.data.mongodb-api.com/app/application-0-bcdsp/endpoint/insertPengguna";
...
//                            Toast.makeText(SignUp.this, "Registration failed! Error parsing JSON", Toast.LENGTH_SHORT).show();
                        ...
                        Toast.makeText(SignUp.this, "Akun Berhasil Terdaftar!", Toast.LENGTH_SHORT).show();
                        Intent loginIntent = new Intent(SignUp.this, beranda1.class);
            ...
            protected Map<String, String> getParams() {
                ...
                params.put("notlp", no_tlpn.getText().toString());
    ...
    private void saveUserData() {
        ...
        editor.putString("no_hp", no_tlpn.getText().toString());
...
//    }
    ...
    private void handleVolleyError(VolleyError error) {
        if (error.networkResponse != null) {
            ...
            Toast.makeText(SignUp.this, "Error: " + statusCode, Toast.LENGTH_SHORT).show();
        } else {
